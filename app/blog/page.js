                  ...
                  <article className="flex flex-col space-y-2 xl:space-y-0">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="prose max-w-none text-gray-500 dark:text-gray-400">
                        ...
                        This can be used to group posts of similar content e.g.
                        a multi-part course. This post is itself an example of a
                        nested route!
                      </div>
                    </div>
                  </article>
                ...
                <li className="py-5">
                  <article className="flex flex-col space-y-2 xl:space-y-0">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="prose max-w-none text-gray-500 dark:text-gray-400">
                        How to derive the OLS Estimator with matrix notation and
                        a tour of math typesetting using markdown with the help
                        of KaTeX.
                      </div>
                    </div>
                  </article>
